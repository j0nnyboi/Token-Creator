    ...
    return (
        <div className="">
            <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content">
                <div className="pl-2">
                        <a href="https://safecoin.org" target="_blank"><img src="SafeCoin.svg" alt="https://safecoin.org" width="50" height="50"/></a>
                </div>
                <div className="max-w-md mx-auto sm:pl-12 grid-flow-col gap-4 text-center">
                    <a href="https://github.com/ledamint-IO" target="_blank">
