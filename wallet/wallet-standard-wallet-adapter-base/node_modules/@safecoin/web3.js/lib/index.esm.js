...
class TransactionExpiredTimeoutError extends Error {
  constructor(signature, timeoutSeconds) {
    super(`Transaction was not confirmed in ${timeoutSeconds.toFixed(2)} seconds. It is ` + 'unknown if it succeeded or failed. Check signature ' + `${signature} using the Safecoin Explorer or CLI tools.`);
    this.signature = void 0;
    this.signature = signature;
  }
}
...
const SafecoinJSONRPCErrorCode = {
...
class SafecoinJSONRPCError extends Error {
  constructor({
    code,
    message,
    data
    ...
    if (httpAgent == null) {
      {
        const agentOptions = {
          ...
          // Read more: https://github.com/Fair-Exchange/solana/issues/27859#issuecomment-1340097889
...
class Connection {
   ...
   * https://github.com/Fair-Exchange/solana/issues/18892
   */
  /** @internal */
  ...
  async getBalanceAndContext(publicKey, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get balance for ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getBlockTime(slot) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get block time for slot ${slot}`);
    }
    return res.result;
  }
  ...
  async getMinimumLedgerSlot() {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get minimum ledger slot');
    }
    return res.result;
  }
  ...
  async getFirstAvailableBlock() {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get first available block');
    }
    return res.result;
  }
  ...
  async getTokenAccountBalance(tokenAddress, commitment) {
    ...
    const res = create(unsafeRes, jsonRpcResultAndContext(TokenAmountResult));
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get token account balance');
    }
    return res.result;
  }
  ...
  async getTokenAccountsByOwner(ownerAddress, filter, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get token accounts owned by account ${ownerAddress.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getTokenLargestAccounts(mintAddress, commitment) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get token largest accounts');
    }
    return res.result;
  }
  ...
  async getAccountInfoAndContext(publicKey, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get info about account ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getMultipleParsedAccounts(publicKeys, rawConfig) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get info for accounts ${keys}`);
    }
    return res.result;
  }
  ...
  async getStakeActivation(publicKey, commitmentOrConfig, epoch) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get Stake Activation ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getProgramAccounts(programId, configOrCommitment) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get accounts owned by program ${programId.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getTransactionCount(commitmentOrConfig) {
    ...
    const res = create(unsafeRes, jsonRpcResult(number()));
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get transaction count');
    }
    return res.result;
  }
  ...
  async getRecentPerformanceSamples(limit) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get recent performance samples');
    }
    return res.result;
  }
  ...
  async getBlock(slot, rawConfig) {
    ...
    try {
      ...
      throw new SafecoinJSONRPCError(e, 'failed to get confirmed block');
    }
  }
  ...
  async getParsedBlock(slot, rawConfig) {
    ...
    try {
      ...
      throw new SafecoinJSONRPCError(e, 'failed to get block');
    }
  }
  ...
  async getBlockHeight(commitmentOrConfig) {
    ...
    const res = create(unsafeRes, jsonRpcResult(number()));
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get block height information');
    }
    return res.result;
  }
  ...
  async getBlockProduction(configOrCommitment) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get block production information');
    }
    return res.result;
  }
  ...
  async getParsedConfirmedTransaction(signature, commitment) {
    ...
    const res = create(unsafeRes, GetParsedTransactionRpcResult);
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get confirmed transaction');
    }
    return res.result;
  }
  ...
  async getParsedConfirmedTransactions(signatures, commitment) {
    ...
    const res = unsafeRes.map(unsafeRes => {
      const res = create(unsafeRes, GetParsedTransactionRpcResult);
      if ('error' in res) {
        throw new SafecoinJSONRPCError(res.error, 'failed to get confirmed transactions');
      }
      return res.result;
    });
    return res;
  ...
  async getConfirmedSignaturesForAddress2(address, options, commitment) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get confirmed signatures for address');
    }
    return res.result;
  }
  ...
  async getSignaturesForAddress(address, options, commitment) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, 'failed to get signatures for address');
    }
    return res.result;
  }
  ...
  async requestAirdrop(to, lamports) {
    ...
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `airdrop to ${to.toBase58()} failed`);
    }
    return res.result;
  }
  ...
  async getStakeMinimumDelegation(config) {
    ...
    const res = create(unsafeRes, jsonRpcResultAndContext(number()));
    if ('error' in res) {
      throw new SafecoinJSONRPCError(res.error, `failed to get stake minimum delegation`);
    }
    return res.result;
  }
...
export { Account, AddressLookupTableAccount, AddressLookupTableInstruction, AddressLookupTableProgram, Authorized, BLOCKHASH_CACHE_TIMEOUT_MS, BPF_LOADER_DEPRECATED_PROGRAM_ID, BPF_LOADER_PROGRAM_ID, BpfLoader, COMPUTE_BUDGET_INSTRUCTION_LAYOUTS, ComputeBudgetInstruction, ComputeBudgetProgram, Connection, Ed25519Program, Enum, EpochSchedule, FeeCalculatorLayout, Keypair, LAMPORTS_PER_SAFE, LOOKUP_TABLE_INSTRUCTION_LAYOUTS, Loader, Lockup, MAX_SEED_LENGTH, Message, MessageAccountKeys, MessageV0, NONCE_ACCOUNT_LENGTH, NonceAccount, PACKET_DATA_SIZE, PUBLIC_KEY_LENGTH, PublicKey, SAFECOIN_SCHEMA, SIGNATURE_LENGTH_IN_BYTES, STAKE_CONFIG_ID, STAKE_INSTRUCTION_LAYOUTS, SYSTEM_INSTRUCTION_LAYOUTS, SYSVAR_CLOCK_PUBKEY, SYSVAR_EPOCH_SCHEDULE_PUBKEY, SYSVAR_INSTRUCTIONS_PUBKEY, SYSVAR_RECENT_BLOCKHASHES_PUBKEY, SYSVAR_RENT_PUBKEY, SYSVAR_REWARDS_PUBKEY, SYSVAR_SLOT_HASHES_PUBKEY, SYSVAR_SLOT_HISTORY_PUBKEY, SYSVAR_STAKE_HISTORY_PUBKEY, SafecoinJSONRPCError, SafecoinJSONRPCErrorCode, Secp256k1Program, SendTransactionError, StakeAuthorizationLayout, StakeInstruction, StakeProgram, Struct, SystemInstruction, SystemProgram, Transaction, TransactionExpiredBlockheightExceededError, TransactionExpiredNonceInvalidError, TransactionExpiredTimeoutError, TransactionInstruction, TransactionMessage, TransactionStatus, VALIDATOR_INFO_KEY, VERSION_PREFIX_MASK, VOTE_PROGRAM_ID, ValidatorInfo, VersionedMessage, VersionedTransaction, VoteAccount, VoteAuthorizationLayout, VoteInit, VoteInstruction, VoteProgram, clusterApiUrl, sendAndConfirmRawTransaction, sendAndConfirmTransaction };
