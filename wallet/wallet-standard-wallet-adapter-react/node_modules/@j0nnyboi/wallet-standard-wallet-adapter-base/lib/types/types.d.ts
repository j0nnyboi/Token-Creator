import { isWalletAdapterCompatibleStandardWallet, type StandardWalletAdapter, type WalletAdapterCompatibleStandardWallet } from '@j0nnyboi/wallet-adapter-base';
/**
 * @deprecated Use `StandardWalletAdapter` from `@solana/wallet-adapter-base` instead.
 *
 * @group Deprecated
 */
export declare type StandardAdapter = StandardWalletAdapter;
/**
 * @deprecated Use `WalletAdapterCompatibleStandardWallet` from `@solana/wallet-adapter-base` instead.
 *
 * @group Deprecated
 */
export declare type WalletAdapterCompatibleWallet = WalletAdapterCompatibleStandardWallet;
/**
