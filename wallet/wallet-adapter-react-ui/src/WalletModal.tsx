import type { WalletName } from '@j0nnyboi/wallet-adapter-base';
import { WalletReadyState } from '@j0nnyboi/wallet-adapter-base';
import type { Wallet } from '@j0nnyboi/wallet-adapter-react';
                ...
                <div className="wallet-adapter-modal-container">
                    <div className="wallet-adapter-modal-wrapper">
                        ...
                        {listedWallets.length ? (
                            <>
                                <h1 className="wallet-adapter-modal-title">Connect a wallet on Safecoin to continue</h1>
                            ...
                            <>
                                <h1 className="wallet-adapter-modal-title">
                                    You'll need a wallet on Safecoin to continue
                                </h1>
